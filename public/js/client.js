...
function setButtonsToolTip() {
  ...
  // main buttons
  setTippy(shareRoomBtn, "Invite Others", "right-start");
  setTippy(hideMeBtn, "Hide me", "right-start");
  setTippy(audioBtn, "Toggle Mic", "right-start");
  setTippy(videoBtn, "Toggle Video", "right-start");
  ...
  setTippy(chatRoomBtn, "Send Message", "right-start");
  ...
  setTippy(leaveRoomBtn, "Exit Room", "right-start");
  // chat room buttons
...
function initClientPeer() {
  if (!isWebRTCSupported) {
    return userLog("error", "This browser is not supported, try a modern browser!");
  }
